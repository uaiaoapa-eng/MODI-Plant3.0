...
- **초등** 실과 5~6학년 · **40분** 수업 × 9차시
- **중등** 정보 · **45분** 수업 × 9차시
- **고등** 정보 · **50분** 수업 × 9차시
- 구성 원칙: **차시마다 서로 다른 작품**을 완성 (1~3차시 Web 작품 3개, 4~6차시
  MODI H/W 작품 3개), 7~9차시는 **자율주행 로봇카** 프로젝트를 3차시 블록으로
  단계별 완성 (최종 목표: MODI 로봇카와 연동된 웹 리모컨·관제 대시보드)
